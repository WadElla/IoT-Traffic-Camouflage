...
original_dataset_path = "AD_dataset/ad_ori.csv"
...
new_dataset_path = 'AD_dataset/ad_frag.csv'
...
for model_name, model in models.items():
    ...
    for train_index, test_index in skf.split(X_orig_scaled, y_orig):
        ...
        precision_scores_orig.append(precision_score(y_test_fold, y_pred_fold_orig, average='macro'))
        recall_scores_orig.append(recall_score(y_test_fold, y_pred_fold_orig, average='macro'))
        f1_scores_orig.append(f1_score(y_test_fold, y_pred_fold_orig, average='macro'))
...
results_df.to_csv("model_metrics_with_ci_obfuscated.csv", index=False)
